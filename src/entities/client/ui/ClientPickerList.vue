...
const props = defineProps<{
  clients: Client[]
  /** Fill the parent's height (for full-screen editors) instead of the default capped list. */
  fill?: boolean
}>()
...
<template>
  <div class="space-y-3" :class="fill ? 'flex h-full min-h-0 flex-col' : ''">
    ...
    <div
      ...
      :class="fill ? 'min-h-0 flex-1' : 'max-h-80'"
    >
      <section
