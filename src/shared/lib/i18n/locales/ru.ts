export default {
  ...
  onboarding: {
    ...
    step3: {
      ...
      address: 'Адрес',
      addressPlaceholder: 'ул. Пушкина, д. 1',
      zipCode: 'Почтовый индекс',
      zipCodePlaceholder: '123456',
      floor: 'Этаж',
      floorPlaceholder: '3',
      apartment: 'Квартира / офис',
      apartmentPlaceholder: 'Офис 12',
      entranceCode: 'Код домофона',
      entranceCodePlaceholder: '1234',
      entranceCodeHelp: 'Отправляется клиенту после подтверждения записи',
      ...
      validation: {
        ...
        zipCodeRequired: 'Введите почтовый индекс',
      },
    },
    step5: {
