export default {
  ...
  quickCreate: {
    ...
    appointment: {
      ...
      dateTime: {
        ...
        allDay: 'Весь день',
        past: {
          title: 'Прошедший день',
          description:
            'Этот день уже прошёл. Запись добавится как подтверждённая — завершите её через чек-аут, чтобы записать выручку. Укажите время вручную ниже.',
        },
      },
      confirm: {
        client: 'Клиент',
    ...
    timeOff: {
      ...
      hasAppointments:
        'На этот день уже есть записи. Выберите свободный интервал или задайте время внутри него.',
      freeTitle: 'Свободное время',
      noFreeTime: 'На эту дату нет свободного времени для перерыва.',
      overlap: 'Выбранное время пересекается с записью.',
    },
  },
  ...
  services: {
    ...
    deleteError: 'Не удалось удалить услугу',
    form: {
  ...
  settings: {
    ...
    about: {
      title: 'О приложении',
      description: 'Ваш личный помощник для работы с клиентами и записями.',
      body: 'Seene помогает бьюти-мастерам управлять расписанием, записями, клиентами и доходами — всё необходимое для ежедневной работы в одном приложении.',
      version: 'Версия',
    },
    profile: {
      title: 'Профиль',
    ...
    contacts: {
      ...
      subtitle: 'Способы связи и адрес, которые клиенты видят на вашей странице записи.',
      waysToContact: 'Способы связи',
      phone: 'Телефоны',
      phonePlaceholder: 'Введите номер телефона',
      whatsapp: 'WhatsApp',
    ...
    systemRegion: {
      ...
      appearanceDescription: 'Основной цвет элементов приложения.',
      currency: 'Валюта',
    ...
    paymentTypes: {
      ...
      subtitle:
        'Используйте способы оплаты, чтобы понимать, где находятся деньги, и точнее вести бюджет.',
      featureToggle: {
        label: 'Учитывать способы оплаты',
        description: 'Распределять доходы по способам оплаты при ведении бюджета.',
      },
      ...
      form: {
        ...
        color: 'Цвет',
        active: 'Активен',
        activeDescription: 'Показывать этот способ при добавлении оплаты.',
  ...
  clients: {
    ...
    details: {
      ...
      booking: 'Записать клиента',
      bookingSoon: 'Создание записи скоро будет доступно',
  ...
  appointments: {
    ...
    delete: {
      ...
      messageWithSale:
        'У этой записи есть зафиксированная продажа — удаление также удалит эту выручку. Действие невозможно отменить.',
      confirm: 'Удалить',
      cancel: 'Отмена',
    },
    ...
    preview: {
      ...
      notifyTitle: 'Уведомить клиента',
      notifyComingSoon: 'Уведомления клиента скоро появятся.',
      editTitle: 'Редактирование записи',
      date: 'Дата',
      time: 'Время',
      dateTimeTitle: 'Дата и время',
      dateTimeComingSoon: 'Здесь скоро можно будет изменить дату и время записи.',
      paymentMethod: 'Способ оплаты',
      selectClient: 'Выбор клиента',
      clientUpdateSuccess: 'Клиент изменён',
      clientUpdateError: 'Не удалось изменить клиента',
      servicesUpdateSuccess: 'Услуги изменены',
      servicesUpdateError: 'Не удалось изменить услуги',
      selectServices: 'Выбор услуг',
      done: 'Готово',
      save: 'Сохранить',
      client: 'Клиент',
      services: 'Услуги',
      ...
      missingService: 'Недоступная услуга | Недоступных услуг: {n}',
      missingServiceHint: 'Возможно, услуга была удалена из каталога',
      serviceSubtotal: 'Стоимость услуг',
      customPrice: 'Своя цена',
      paymentUnavailable: 'Данные об оплате недоступны',
      ...
      sessionStatus: {
        ...
        ongoing: 'В процессе',
        past: 'Ожидает завершения',
        completed: 'Завершён',
        cancelled: 'Отменён',
        no_show: 'Не явился',
        expired: 'Истёк',
      },
      priceChanged: 'Цена изменена при оплате',
    },
    validation: {
