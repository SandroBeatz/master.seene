export default {
  ...
  settings: {
    ...
    profile: {
      ...
      username: "Nom d'utilisateur",
      usernameHint: 'Votre lien unique. Lettres, chiffres et points uniquement.',
      usernameAvailable: 'Disponible',
      usernameTaken: 'Pris',
      usernameInvalid: 'Lettres, chiffres et points uniquement.',
    ...
    contacts: {
      ...
      comingSoon: 'Les contacts et réseaux sociaux arrivent bientôt.',
    },
    workingHours: {
