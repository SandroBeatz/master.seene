export default {
  ...
  services: {
    ...
    active: 'Actif',
    inactive: 'Inactif',
    countSummary: '{total} services · {active} actifs',
    filterAll: 'Tous',
    picker: {
      title: 'Choisir des services',
    ...
    form: {
      ...
      categoryNamePlaceholder: 'Nom de la nouvelle catégorie',
      categoryCreateConfirm: 'Créer la catégorie',
  ...
  settings: {
    ...
    serviceCategories: {
      ...
      subtitle: 'Organisez vos services par catégories.',
      addButton: 'Ajouter une catégorie',
      empty: 'Aucune catégorie pour le moment. Créez-en une pour regrouper vos services.',
      ...
      deleteConfirmBody:
        'Supprimer la catégorie « {name} » ? Les services de cette catégorie continueront de fonctionner et deviendront sans catégorie.',
      deleteAction: 'Supprimer',
      deleteSuccess: 'Catégorie supprimée',
      deleteError: 'Échec de la suppression de la catégorie',
      form: {
        titleCreate: 'Ajouter une catégorie',
        titleEdit: 'Modifier la catégorie',
        name: 'Nom',
        namePlaceholder: 'ex. Cils',
        cancel: 'Annuler',
        submitCreate: 'Créer',
  ...
  clients: {
    ...
    favorite: {
      ...
      error: 'Échec de la mise à jour du favori',
    },
    section: {
      favorites: 'Favoris',
      others: 'Autres',
    ...
    details: {
      ...
      booking: 'Réserver pour le client',
      bookingSoon: 'La réservation sera bientôt disponible',
      editButton: 'Modifier',
  ...
  appointments: {
    ...
    preview: {
      ...
      dateTimeComingSoon: 'La modification de la date et de l’heure sera bientôt disponible ici.',
      paymentMethod: 'Moyen de paiement',
      selectClient: 'Choisir un client',
      clientUpdateSuccess: 'Client mis à jour',
      clientUpdateError: 'Impossible de modifier le client',
      servicesUpdateSuccess: 'Services mis à jour',
      servicesUpdateError: 'Impossible de modifier les services',
      ...
      missingService: 'Service indisponible | {n} services indisponibles',
      missingServiceHint: 'Il a peut-être été supprimé du catalogue',
      serviceSubtotal: 'Sous-total des services',
      customPrice: 'Prix personnalisé',
      paymentUnavailable: 'Les détails du paiement sont indisponibles',
      callClient: 'Appeler',
      ...
      sessionStatus: {
        ...
        confirmed: 'Confirmée',
        ongoing: 'En cours',
        past: 'En attente de clôture',
        completed: 'Terminée',
        cancelled: 'Annulée',
        no_show: 'Absent',
        expired: 'Expirée',
      },
      priceChanged: 'Prix ajusté lors du paiement',
    },
    validation: {
