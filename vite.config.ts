...
// Shared across both build targets (desktop + mobile Ionic).
const aliases = {
  '@': fileURLToPath(new URL('./src', import.meta.url)),
  '@app': fileURLToPath(new URL('./src/app', import.meta.url)),
  '@app-mobile': fileURLToPath(new URL('./src/app-mobile', import.meta.url)),
...
export default defineConfig(() => {
  // `BUILD_TARGET=mobile` selects the Ionic bundle: mobile.html entry,
  // dist-mobile output, Tailwind without Nuxt UI. Anything else = desktop.
